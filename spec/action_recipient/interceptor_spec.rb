RSpec.describe ActionRecipient::Interceptor do
  ...
  describe '.delivering_email' do
    ...
    context 'with non-whitelisted addresses' do
      before do
        ActionRecipient.config.whitelist = ['foo@foo.co.fr', 'bar@bar.jm']
      end
    ...
    context 'with partially whitelisted addresses' do
      before do
        ActionRecipient.config.whitelist = [to_addresses.last, cc_addresses.last, bcc_addresses.last, 'foo@foo.co.fr', 'bar@bar.jm']
      end
    ...
    context 'with whitelisted addresses' do
      before do
        ActionRecipient.config.whitelist = [*to_addresses, *cc_addresses, *bcc_addresses]
      end
